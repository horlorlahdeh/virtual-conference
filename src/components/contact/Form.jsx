            ...
            <div className="w-10/12 mx-auto max-w-screen">
                <form action="">
                    ...
                    <div className="flex flex-col md:flex-row gap-x-8 lg:mb-8">
                        <input type="text" placeholder="Name" className="bg-transparent border border-gray-700 p-4 text-gray-300 focus:text-white focus:border-gray-700 w-full mb-4" />
                        <input type="text" placeholder="Email Address" className="bg-transparent border border-gray-700 p-4 text-gray-300 focus:text-white w-full mb-4" />
                    </div>
                    <input type="textarea" placeholder="" className="w-full h-40 bg-transparent border border-gray-700 text-gray-300 focus:text-white p-4 pt-0 mb-4" />
