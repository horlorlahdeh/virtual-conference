...
const SingleSchedule = () => {
  return (
    <div className="flex flex-col lg:flex-row gap-x-12 mb-16">
        <div className="">
        <div className="bg-home-blue bg-schedule2 bg-home bg-cover bg-pos pt-6 pb-0 lg:pb-28 px-8 lg:pl-10 pr-24 text-white ">
          <p className="text-sm md:text-base lg:text-lg mb-1 lg:mb-4 font-semibold">
            July 13
          </p>
      ...
      <div className="">
        <div className="mt-14 lg:mt-8 mb-20">
          <h5 className="text-schedule-red mb-2 text-xs font-bold tracking-widest">
            9-10AM
          </h5>
