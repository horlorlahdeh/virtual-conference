...
const SingleSchedule = () => {
    return (
        <div className="flex flex-col lg:flex-row gap-x-12 mb-16">
            <div className="">
        <div className="bg-home-pink text-black bg-schedule1 bg-home bg-cover bg-pos pt-6 pb-0 lg:pb-28 px-8 lg:pl-10 pr-24  ">
          ...
          <div className="">
            <div className="mt-14 lg:mt-8 mb-20">
              <h5 className="text-schedule-pink mb-2 text-xs font-bold tracking-widest">
                9-10AM
              </h5>
